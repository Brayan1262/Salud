...
describe('🧪 Prueba funcional - Evaluación de hábitos (Alissa)', () => {
    ...
    // ======================================================
    // CP-04: Validar inicio del cuestionario
    // ======================================================
    it('CP-04: Validar inicio del cuestionario', () => {
        ...
        cy.get('#chatContainer').should('contain.text', '¿En qué puedo ayudarte hoy?');
    });

    // ======================================================
    // CP-05: Validar progreso del cuestionario
    // ======================================================
    it('CP-05: Validar progreso del cuestionario', () => {
    ...
    // ======================================================
    // CP-06: Validar envío final al motor de IA
    // ======================================================
    it('CP-06: Validar envío final al motor de IA', () => {
        // Entrar al asistente
        cy.visit('http://127.0.0.1:8080/Salud/Vista/asistente-ia/asistente-ia.html');
        ...
        cy.get('#chatContainer', { timeout: 7000 })
        .should('contain', 'IMC')
        .and('contain', 'rango saludable')
        .and('contain', 'hábitos');
    });
